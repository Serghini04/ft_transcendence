...
const GameSelection = () => {
  ...
  >
    ...
    <div className="flex flex-col items-center justify-center min-h-screen  text-white pl-0 md:pl-20 p-4 sm:p-6 md:p-8 lg:p-10 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute w-64 sm:w-96 h-64 sm:h-96 bg-green-500/5 rounded-full blur-3xl -bottom-32 sm:-bottom-48 -right-32 sm:-right-48 animate-pulse" 
             style={{ animationDuration: '6s', animationDelay: '2s' }} />
        <div className="absolute w-48 sm:w-72 h-48 sm:h-72 bg-purple-500/5 rounded-full blur-3xl top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 animate-pulse" 
      ...
      <div className="max-w-5xl w-full relative z-10 px-2 sm:px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4 md:gap-6 lg:gap-8 w-full max-w-4xl relative lg:ml-12 z-10 px-2 sm:px-3 md:px-4">
          {/* Local Game Card */}
          <Link to="/tictac" className="group animate-[fadeIn_0.5s_ease-out]">
            <div className="bg-[rgba(79,103,127,0.2)] p-4 sm:p-6 md:p-8 rounded-xl sm:rounded-2xl border-2 border-[#27445E] 
              ...
              <div className="absolute inset-0 bg-gradient-to-br from-blue-500/0 to-blue-500/0 
                            group-hover:from-blue-500/10 group-hover:to-blue-500/20 transition-all duration-300" />
              
              <div className="absolute inset-0 rounded-xl opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-20 h-20 bg-blue-400/20 rounded-full animate-[pulse_2s_ease-in-out_infinite]" />
              </div>
          ...
          <Link to="/tictac/online" className="group animate-fadeIn">
            <div className="bg-[rgba(79,103,127,0.2)] p-4 sm:p-6 md:p-8 rounded-xl sm:rounded-2xl border-2 border-[#27445E] 
                          ...
                          backdrop-blur-sm cursor-pointer h-full relative overflow-hidden">
              {/* Animated gradient overlay */}
              <div className="absolute inset-0 bg-gradient-to-br from-green-500/0 to-emerald-500/0 
                            group-hover:from-green-500/10 group-hover:to-emerald-500/20 transition-all duration-300" />
              
              {/* Pulse effect on hover */}
              <div className="absolute inset-0 rounded-xl opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-20 h-20 bg-green-400/20 rounded-full animate-[pulse_2s_ease-in-out_infinite]" />
              </div>
        ...
        <div className="mt-6 sm:mt-8 md:mt-12 bg-[rgba(79,103,127,0.15)] p-3 sm:p-4 md:p-6 rounded-xl border border-[#27445E] backdrop-blur-sm
                      ...
                      animate-[fadeIn_0.5s_ease-out_0.4s] opacity-0" style={{ animation: 'fadeIn 0.5s ease-out 0.4s forwards' }}>
