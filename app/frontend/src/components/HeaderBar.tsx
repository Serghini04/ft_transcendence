    ...
    <header className="fixed top-0 left-20 right-0 h-20 flex items-center justify-between px-4 sm:px-6 md:px-10 bg-transparent backdrop-blur-md z-30 overflow-visible">
      ...
      <div className="flex items-center gap-2 sm:gap-4 md:gap-9 flex-1">
        ...
        <IconButton
          ...
          className="block md:!hidden text-white hover:text-gray-300 p-1 sm:p-2"
        >
          <Menu size={26} className="text-gray-400" />
        </IconButton>

        {/* Search Bar */}
        <div className="flex-1 flex items-center bg-[rgba(13,34,52,0.5)] rounded-full px-2 py-1.5 sm:px-3 sm:py-2 shadow-md hover:shadow-lg transition-all max-w-[120px] sm:max-w-[180px] md:max-w-[350px] lg:max-w-[420px]">
