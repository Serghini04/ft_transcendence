...
export default function Input(props: InputProps)
{
	...
	return (
		<div className="flex flex-col ml-[1.4vw] h-full justify-center">
			...
			<input onChange={props.onChange} type={ispasswordhide ? props.type : "text"} placeholder={props.text} {...(props.readonlyFlag ? { readOnly: true } : {})}  className={`text-[#D2D2D2] h-8 w-90 sm:h-10 sm:w-120 lg:w-[27vw] lg:h-[3.3vw] pl-[1.8vw] text-xs lg:text-[0.8vw] border-[0.3vw] sm:border-[0.2vw] lg:border-[0.1vw] rounded-[0.25rem] sm:rounded-[0.5rem] lg:rounded-[0.5vw] bg-[rgba(1,9,16,50%)] ${props.ErrorMsg ? "border-red-600" : "border-[#27445E]"} outline-none `} />
